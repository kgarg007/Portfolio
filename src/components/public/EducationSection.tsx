...
export default function EducationSection({ content, education }: EducationSectionProps) {
  ...
  return (
    <section id="education" className="py-16 border-t border-[#202024] bg-[#101012] relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {education.map((edu) => (
            <div
              ...
              className="rounded-xl bg-[#161618] border border-[#202024] p-6 flex flex-col gap-4 hover:border-white/20 transition-all shadow-sm"
            >
              <div className="flex items-start justify-between gap-3 border-b border-[#202024] pb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#FAFAFA] font-sans leading-snug">
                      {edu.degree}
                    </h3>
                ...
                <div className="flex flex-col items-end gap-1.5 font-mono text-xs text-zinc-400 shrink-0">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#101012] border border-[#202024]">
              ...
              {edu.courses && edu.courses.length > 0 && (
                <div className="flex flex-col gap-2 pt-2 border-t border-[#202024] font-mono text-xs">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {edu.courses.map((course) => (
                      <span
                        key={course}
                        className="px-2.5 py-1 rounded bg-[#101012] border border-[#202024] text-zinc-300 text-[11px]"
                      >
                        {course}
                      </span>
                    ))}
