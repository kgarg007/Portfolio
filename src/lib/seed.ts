...
export async function seedDatabase() {
  ...
  const defaultContents = [
    ...
    { key: 'hero_headline', group: 'hero', value: 'Building intelligent digital products that solve real-world problems.' },
    { key: 'hero_description', group: 'hero', value: 'B.Tech CSE student at GGSIPU (MSIT) with CGPA 9.4 / 10. Passionate about web engineering, data analytics, and startup incubation.' },
    { key: 'hero_primary_cta_label', group: 'hero', value: 'Explore Featured Work' },
    { key: 'hero_primary_cta_dest', group: 'hero', value: '#projects' },
    { key: 'hero_secondary_cta_label', group: 'hero', value: 'Download CV' },
    { key: 'hero_secondary_cta_dest', group: 'hero', value: '#resume' },
    
    { key: 'about_eyebrow', group: 'about', value: 'ABOUT ME' },
    { key: 'about_heading', group: 'about', value: 'Architecting scalable web applications & data systems' },
    { key: 'about_intro', group: 'about', value: "I'm a motivated B.Tech CSE student at GGSIPU (MSIT, New Delhi) holding a 9.4 CGPA. Skilled in HTML, CSS, JavaScript, React, Python, SQL, Pandas, and NumPy." },
    { key: 'about_description', group: 'about', value: "Deeply passionate about modern web performance, full-stack engineering, and data analysis. I serve as Deputy Head of the Incubation Department at E-Cell MSIT, where I mentor student startups and evaluate MVP architectures." },
    
    { key: 'projects_eyebrow', group: 'projects_sec', value: 'SELECTED WORK' },
    { key: 'projects_heading', group: 'projects_sec', value: 'Featured Engineering Case Studies' },
    { key: 'projects_description', group: 'projects_sec', value: 'A curated selection of full-stack web applications, hackathon entries, and foundation projects built with modern web technologies.' },

    { key: 'exp_eyebrow', group: 'exp_sec', value: 'CAREER & LEADERSHIP' },
    { key: 'exp_heading', group: 'exp_sec', value: 'Work Experience & Incubations' },
    { key: 'exp_description', group: 'exp_sec', value: 'Demonstrated experience in frontend web development, mentorship, hackathon evaluation, and technical leadership.' },

    { key: 'skills_eyebrow', group: 'skills_sec', value: 'TECHNICAL PROFICIENCY' },
    { key: 'skills_heading', group: 'skills_sec', value: 'Tech Stack & Core Capabilities' },
    ...
    { key: 'edu_heading', group: 'edu_sec', value: 'Education & Honors' },

    { key: 'ach_eyebrow', group: 'ach_sec', value: 'RECOGNITION' },
    { key: 'ach_heading', group: 'ach_sec', value: 'Achievements & Certifications' },

    { key: 'contact_eyebrow', group: 'contact', value: 'GET IN TOUCH' },
    { key: 'contact_heading', group: 'contact', value: "HAVE AN IDEA? LET'S BUILD SOMETHING EXTRAORDINARY." },
    { key: 'contact_description', group: 'contact', value: "I'm currently open to internships, full-stack development roles, and engineering collaborations. Drop a message or reach out directly!" },
    
    { key: 'footer_subtext', group: 'footer', value: 'Building products, learning continuously.' },
